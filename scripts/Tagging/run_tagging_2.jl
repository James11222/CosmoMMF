...
@load config["output_directory"] * "NEXUS/" * "max_sigs_" * save_name * "_full_signatures.jld2" sigmax
sigmax_NEXUS = sigmax

print("Importing NEXUS+ Signatures... \n")
save_name = config["run_name"] * "_NEXUSPLUS"
@load config["output_directory"] * "NEXUSPLUS/" *"max_sigs_" * save_name * "_full_signatures.jld2" sigmax
