...
function calc_structure_bools(mass_of_average_cell, cluster_threshold, combined_NEXUS::AbstractArray{T,4}, combined_NEXUSPLUS::AbstractArray{T,4}, den) where T
    ...
    print("Starting Filament Tagging: \n")
    ...
    print("Filaments:")
    print("Max dM is ", max_dM, "\n")
    print("Corresponding Index is ", ind + 2, "\n")
    filament_thresh = S_fil[ind + 2]
    
    print("Starting Wall Tagging: \n")
