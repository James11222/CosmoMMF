...
#               'xmax' : 205000.0, 
#               'xmin' : 0.0,
#               'input_dir' : '/global/cscratch1/sd/james12/Illustris_TNG_Data/Dark_Sims/' + snapdir_str,
#               'output_dir' : '/global/cscratch1/sd/james12/Illustris_TNG_Data/TNG_Density_Cubes/'}
...
#               'xmax' : 205000.0, 
#               'xmin' : 0.0,
#               'input_dir' : '/global/cscratch1/sd/james12/Illustris_TNG_Data/Full_Sims/' + snapdir_str,
#               'output_dir' : '/global/cscratch1/sd/james12/Illustris_TNG_Data/TNG_Density_Cubes/'}
...
def compute_snap(snapnum, run_type):
    ...
    if run_type=='dark':
        ...
        mesh = combined.to_mesh(Nmesh=config['nx'], BoxSize=config["xmax"] - config['xmin'], resampler='tsc',  
